            ...
            <div className="fixed inset-0 w-screen h-screen overflow-hidden">
                ...
                <div className="relative z-10 w-full h-full flex flex-row items-center p-6 md:p-10 lg:p-12 pb-24">
                    ...
                    <div className="flex-1 flex flex-col justify-center max-w-3xl pr-4">
                        ...
                        <span
                            className={`font-display text-base md:text-lg text-[hsl(40,30%,92%)] tracking-[0.2em] uppercase mb-1 block transition-all duration-[4000ms] ease-out ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'
                                }`}
                        >
                            The founder
                        </span>
                        ...
                        <h2
                            className={`font-display text-3xl md:text-4xl lg:text-5xl text-white mb-1 transition-all duration-[4000ms] delay-[2000ms] ease-out ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'
                                }`}
                        >
                            Nadja Reiche
                        </h2>
                        ...
                        <div
                            className={`font-display text-sm md:text-base text-[hsl(40,25%,88%)] leading-relaxed space-y-2 text-justify transition-all duration-[3500ms] delay-[6000ms] ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
                                }`}
                        >
                            <p>
                    ...
                    <div className="absolute right-8 md:right-12 lg:right-16 bottom-20 md:bottom-24">
                        <div
                            className={`transition-all duration-[4000ms] delay-[1000ms] ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                                }`}
                        >
